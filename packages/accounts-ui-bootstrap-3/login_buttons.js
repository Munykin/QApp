(function() {
    ...
    Accounts._loginButtons.validateUsername = function(username) {
        if (username.length >= 3) {
            ...
            loginButtonsSession.errorMessage("Логин должен быть длинее 3 символов");
            return false;
        }
    };
    Accounts._loginButtons.validateEmail = function(email) {
        ...
        if (re.test(email)) {
            ...
            loginButtonsSession.errorMessage("Неправильный E-Mail");
            return false;
        }
    };
    Accounts._loginButtons.validatePassword = function(password) {
        if (password.length >= 6) {
            ...
            loginButtonsSession.errorMessage("Пароль должен быть длиннее 6 символов");
            return false;
        }
    };
